...
public class WatchProgressController {
   ...
   * @throws com.example.app.exception.ResourceNotFoundException if episode does not exist (returns
   *     404)
   * @throws IllegalArgumentException if required fields are missing (handled by Spring/Jackson)
   */
  @PostMapping("/save")
