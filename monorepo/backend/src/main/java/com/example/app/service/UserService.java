...
public class UserService {
    ...
    // table.
    private static final List<String> AVAILABLE_INTERESTS = List.of(
            "Python Programming", "Data Science", "UI/UX Design", "Digital Marketing",
            "Cloud Computing", "Cybersecurity", "React Framework", "Personal Finance");
