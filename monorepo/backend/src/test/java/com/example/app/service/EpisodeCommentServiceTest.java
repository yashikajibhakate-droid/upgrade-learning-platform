...
public class EpisodeCommentServiceTest {
        ...
        void getApprovedComments_ShouldReturnOnlyApproved() {
                ...
                EpisodeComment c2 = new EpisodeComment(episodeId, "other@example.com", "Good",
                                EpisodeComment.Status.APPROVED);
                ...
                verify(commentRepository)
                                .findByEpisodeIdAndStatusOrderByCreatedAtDesc(episodeId,
                                                EpisodeComment.Status.APPROVED);
        }
}
